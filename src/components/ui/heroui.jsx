...
export default function HeroUI({
  ...
  return (
    <section
      ref={ref}
      className={cn("relative overflow-hidden min-h-[90vh] flex items-center", className)}>
      ...
      <div
        className="container relative z-10 mx-auto px-4 py-6 sm:py-8 md:py-16 lg:py-24">
        <div className="relative min-h-[60vh] md:min-h-[70vh]">
            ...
            <div className="w-full h-[220px] md:h-[300px] lg:h-[400px] xl:h-[450px]">
              <Globe
                baseColor={
                  theme === "dark"
                    ? (globeBaseColor.dark)
                    : (globeBaseColor.light)
                }
                markerColor={
                  theme === "dark"
                    ? (globeMarkerColor.dark)
                    : (globeMarkerColor.light)
                }
                glowColor={
                  theme === "dark"
                    ? (globeGlowColor.dark)
                    : (globeGlowColor.light)
                } />
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            <motion.h1
              ...
              <span
                className="block bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-400 bg-clip-text text-transparent">
                {title}
              </span>
