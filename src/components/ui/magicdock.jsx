...
function DockItem({
  ...
  const rotate = useSpring(useTransform(x, [-100, 100], [-15, 15]), tooltipSpringConfig);
  const translateX = useSpring(useTransform(x, [-100, 100], [-20, 20]), tooltipSpringConfig);
            ...
            <motion.div
              ...
              {variant === "tooltip" && (
                <>
                  ...
                  <div
                    className="absolute -bottom-px z-30 h-px w-[40%] bg-gradient-to-r from-transparent via-sky-500 to-transparent" />
                </>
              )}
